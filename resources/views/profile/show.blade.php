                ...
                <nav class="flex flex-col gap-2">
                    ...
                    <a class="flex items-center gap-3 px-3 py-2 rounded text-slate-700 dark:text-slate-300 hover:bg-primary/10 hover:text-primary" href="{{ route('forums.index') }}">
                        <svg fill="currentColor" height="24" viewBox="0 0 256 256" width="24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M128,40a88,88,0,1,0,88,88A88.1,88.1,0,0,0,128,40Zm0,160a72,72,0,1,1,72-72A72.08,72.08,0,0,1,128,200Z"></path>
                            <path d="M222,58a8,8,0,0,0-9.66-2.34L184,67.75V64a8,8,0,0,0-16,0v8.59l-18.34-12.23a8,8,0,1,0-9.32,13.92L160,86.59V96a8,8,0,0,0,16,0V87.41l28.34,18.9a8,8,0,0,0,9.32-14l-19.66-13.1Z"></path>
                        </svg>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                <div class="flex justify-between items-center">
                                    <div>
                                        {{-- CHANGE THIS LINE:Use $review->listing instead of $review->reviewable --}}
                                        <a href="{{ route('listings.show', $review->listing) }}" class="font-semibold text-slate-900 dark:text-white hover:text-primary">
                                            Review for: {{ $review->listing->name }}
                                        </a>
